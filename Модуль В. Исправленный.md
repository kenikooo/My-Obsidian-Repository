...
# Для srv2-cod
mkdir -p /mnt/minio-data-node2-{1,2,3}
# Для srv3-cod
mkdir -p /mnt/minio-data-node3-{1,2,3}
# Для srv4-cod
mkdir -p /mnt/minio-data-node4-{1,2,3}
```
Настраиваем автоматическое монтирование в /etc/fstab:
```bash
...
```bash
MINIO_VOLUMES="http://srv{1...4}-cod.cod.ssa2025/mnt/minio-data-node{1...4}-{1...3}" # Меняем на ссылку
...
MINIO_SERVER_URL="http://srv1-cod.cod.ssa2025" # Добавляем
MINIO_BROWSER_REDIRECT_URL="http://srv1-cod.cod.ssa2025" # Добавляем или меняем существующую
```
